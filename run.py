...
def validate_data(values):
    """
    Inside the try, converts all string values to integers, Raises ValueError
    if string cannot be converted into int, or if there aren't exactly 6 values
    """
    try:
...
def calculate_surplus_data(sales_row):
    """
    Comapare sales with stock and calculate the surplus for each item type.
...
def calculate_stock_data(data):
    """
    Calculate the average stock for each data
    """
